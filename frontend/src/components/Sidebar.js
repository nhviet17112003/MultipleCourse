  ...
  if (role === 'Student') {
    ...
    items = [
      ...
      },
      {
        ...
        icon: <AppstoreOutlined />,
        children: [
          { key: '8', label: <Link to="tutor/courses-list">Student List</Link> },
        ],
      },

      {
        ...
        icon: <AppstoreOutlined />,
        children: [
          { key: '9', label: <Link to="tutor/courses-list">Buyer History</Link> },
          { key: '10', label: <Link to="/createcourse">Activity History</Link> },
          { key: '11', label: <Link to="/updatecourse">Wallet History</Link> },
        ],
      },
